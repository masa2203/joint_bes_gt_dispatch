...
EXP_PARAMS: dict[str, Any] = {
    'n_runs': 3,
    'n_epochs': 1,
    'step_per_epoch': ENV_KWARGS['modeling_period_h'] * 10,
    'seed': 22,
    # Env
    'flatten_obs': True,
    'frame_stack': 1,
...
RL_PARAMS: dict[str, Any] = {
    'lr_actor': 5e-5,  # Default: 1e-3
    'lr_critic': 5e-4,  # Default: 1e-3
    ...
    'train_freq': 200,  # No default, 219 matches 8760h
    'estimation_step': 1,  # Default: 1, for n-step return
